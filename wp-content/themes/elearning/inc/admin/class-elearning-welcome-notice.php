...
class eLearning_Welcome_Notice {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_elearning-install-qdi-plugin', array( $this, 'install_qdi_plugin' ) );
			...
			<div class="elearning-message__content">
				...
				<div class="elearning-message__text">
					...
					<div class="elearning-message__cta">
						<a href="#" class="btn-get-started button button-primary button-hero" data-name="<?php echo esc_attr( 'quick-demo-import' ); ?>" data-slug="<?php echo esc_attr( 'quick-demo-import' ); ?>" aria-label="<?php echo esc_attr( eLearning_Admin::btn_text( false ) ); ?>">
							<?php echo esc_html__( 'Get started with eLearning', 'elearning' ); ?>
						</a>
						<span class="plugin-install-notice"><?php esc_html_e( 'Clicking the button will install and activate the Quick Demo Import plugin.', 'elearning' ); ?></span>
					</div>
				</div>
			</div>
	...
	public function install_qdi_plugin() {
		check_ajax_referer( 'elearning_qdi_install_nonce', 'security' );
		update_option( 'elearning_hide_welcome_notice', 1 );
